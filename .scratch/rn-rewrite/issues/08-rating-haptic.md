...
- [x] 真機上按四顆評分鈕都震得到，四顆一樣 — 真機 2026-08-27
- [x] 震感與 Capacitor 版一致（兩支輪流按，分不出輕重） — 真機 2026-08-27
- [x] 掀開答案、複製、朗讀、切單字本都不震 — 真機 2026-08-27
- [x] 系統設定關掉觸覺回饋時不當掉、也不出錯 — 真機 2026-08-27
- [x] 震的那一下在存檔之前發生（手指立刻有回饋，不等雲端） — 真機 2026-08-27
